set moduleName AddRoundKey_InversMi
set isTopModule 0
...
set C_modelName {AddRoundKey_InversMi}
...
set C_modelArgMapList {[ 
	{ "Name" : "statemt", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "nb", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set Spec2ImplPortList { 
	...
	word { ap_memory {  { word_address0 mem_address 1 9 }  { word_ce0 mem_ce 1 1 }  { word_q0 mem_dout 0 32 }  { word_address1 MemPortADDR2 1 9 }  { word_ce1 MemPortCE2 1 1 }  { word_q1 MemPortDOUT2 0 32 } } }
}

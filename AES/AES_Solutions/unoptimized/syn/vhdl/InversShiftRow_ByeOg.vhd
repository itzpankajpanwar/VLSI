...
entity InversShiftRow_ByeOg_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of InversShiftRow_ByeOg_rom is 
...
entity InversShiftRow_ByeOg is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of InversShiftRow_ByeOg is
    component InversShiftRow_ByeOg_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    InversShiftRow_ByeOg_rom_U :  component InversShiftRow_ByeOg_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

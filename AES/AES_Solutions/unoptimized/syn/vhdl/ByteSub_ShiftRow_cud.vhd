...
entity ByteSub_ShiftRow_cud_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of ByteSub_ShiftRow_cud_rom is 
...
entity ByteSub_ShiftRow_cud is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of ByteSub_ShiftRow_cud is
    component ByteSub_ShiftRow_cud_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    ByteSub_ShiftRow_cud_rom_U :  component ByteSub_ShiftRow_cud_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

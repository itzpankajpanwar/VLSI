...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module decrypt_invSbox_rom (
...
initial begin
    $readmemh("./decrypt_invSbox_rom.dat", ram0);
    $readmemh("./decrypt_invSbox_rom.dat", ram1);
    $readmemh("./decrypt_invSbox_rom.dat", ram2);
end
...
decrypt_invSbox_rom decrypt_invSbox_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
